...
[查看 v1.3.0 完整更新日志](CHANGELOG.md#130---2026-08-04)
...
- **`LaunchPad-Setup-1.3.0-x64.exe`**：推荐，大多数用户选择此安装包；支持自选安装目录，并创建桌面与开始菜单快捷方式。
- **`LaunchPad-Portable-1.3.0-x64.exe`**：免安装便携版，双击即可运行。
